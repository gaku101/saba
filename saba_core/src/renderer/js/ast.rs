...
impl Node {
  ...
  pub fn new_additive_expression(operator: char, left: Option<Rc<Node>>, right: Option<Rc<Node>>) -> Option<Rc<Self>> {
    Some(Rc::new(Node::AdditiveExpression { operator, left, right }))
  }

  pub fn new_assignment_expression(operator: char, left: Option<Rc<Node>>, right: Option<Rc<Node>>) -> Option<Rc<Self>> {
    Some(Rc::new(Node::AssignmentExpression { operator, left, right }))
  }

  pub fn new_member_expression(object: Option<Rc<Self>>, property: Option<Rc<Self>>) -> Option<Rc<Self>> {
  ...
  pub fn new_function_declaration(id: Option<Rc<Self>>, params: Vec<Option<Rc<Self>>>, body: Option<Rc<Self>>) -> Option<Rc<Self>> {
    Some(Rc::new(Node::FunctionDeclaration { id, params, body }))
  }

  pub fn new_call_expression(callee: Option<Rc<Self>>, arguments: Vec<Option<Rc<Self>>>) -> Option<Rc<Self>> {
...
mod tests {
  ...
  fn test_num() {
    ...
    let mut body = Vec::new();
    body.push(Rc::new(Node::ExpressionStatement(Some(Rc::new(Node::NumericLiteral(42))))));
  ...
  fn test_add_nums() {
    ...
    let mut expected = Program::new();
    let mut body = Vec::new();
    body.push(Rc::new(Node::ExpressionStatement(Some(Rc::new(Node::AdditiveExpression {
      operator: '+',
